...
export class CreateSecretDto {
  ...
  @ApiProperty({ description: 'Enable automatic rotation (only for RDS_CREDENTIALS/DOCUMENTDB_CREDENTIALS/AWS_API_KEY)', default: false, required: false })
  @IsOptional()
  @IsBoolean()
  enableRotation?: boolean;

  @ApiProperty({ description: 'Rotation rules configuration', type: Object, required: false, example: { AutomaticallyAfterDays: 30 } })
  @IsOptional()
  @IsObject()
